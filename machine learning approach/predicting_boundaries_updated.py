...
#df_prosodic = pd.read_csv(??)

# 8 FEATURES NEW UFPALIGN ONLY TRAINSET NON FILTERED
features = ['p_dur','n_dur','e_range','e_maxavg_diff','e_avgmin_diff','f0_range','f0_maxavg_diff','f0_avgmin_diff'] # WITHOUT F0 AVG UTT DIFF
scaler = pickle.load(open('scaler_only-trainset_8features_newufpalign_non-filtered.pkl', 'rb'))
chosen_model = pickle.load(open('RF_only-trainset_8features_newufpalign_non-filtered.pkl', 'rb')) 
...
# 8 FEATURES NEW UFPALIGN ONLY TRAINSET
#features = ['p_dur','n_dur','e_range','e_maxavg_diff','e_avgmin_diff','f0_range','f0_maxavg_diff','f0_avgmin_diff'] # WITHOUT F0 AVG UTT DIFF
...
#df_prosodic = pd.read_csv(csv_path) # for example: 'MuPe-Diversidades_newufpalign_8features_only-trainset.csv'
...
# ONLY ONE FILE
path = "./CM_to_predict/CurrentInquiry"
#CM_file = sys.argv[1]

#features_csv_files = []
#features_csv_files.append(path+"/"+CM_file)
#features_csv_files.append(CM_file)
