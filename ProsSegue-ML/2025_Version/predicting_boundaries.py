...
model = 'RandomForest_model_newufpalignversion_articleversion_9features_allmupediversidades.pkl'
...
scaler = pickle.load(open('scaler_prosodic_newufpalignversion_articleversion_9features_allmupediversidades.pkl', 'rb'))

chosen_model = pickle.load(open(model, 'rb'))

seed = 42

df_prosodic = pd.read_csv('MuPe-Diversidades_newufpalignversion_articleversion_9features_allmupediversidades.csv')
