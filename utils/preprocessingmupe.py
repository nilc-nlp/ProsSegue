...
clean_transcription_path = corpus + estado + "/" + inq + "_transcricao_limpa.txt"
locs_path = corpus + estado + "/" + inq + "_locutores.txt"
transcricao_continua_path = corpus + estado + "/" + inq + "_transcricao_continua.txt"

with open(corpus+estado+"/"+inq+'_adjusted.txt', 'r') as file:
    text = file.read()
